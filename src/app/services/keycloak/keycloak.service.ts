...
export class KeycloakService {
      ...
      keycloakAuth
        ...
        .success(() => {
          ...
          KeycloakService.auth.authz.loadUserProfile().success(data => {
            ...
            //this.user.keycloakId = data.attributes.keycloakId[0] ? data.attributes.keycloakId[0] : 'thisIsBadId';
            //this.user.image = data.attributes.image[0];
  ...
  hasManageUsersRole(): boolean {
    return KeycloakService.auth.authz.hasResourceRole('admin');
  }
